...
namespace DataGrid
{
    public partial class MainWindow3 : Window
    {
        ...
        public MainWindow3(string userid, string password)
        {
            InitializeComponent();
            log.Text = userid;
            pass.Text = password;
            ...
            members.Add(new Member { Number = "1",Ball = "300", Name = "John Doe", Specialization = "Программист", Position = "9 класса" });
                ...
                string sqlQuery = "SELECT id as Number,Ребенок as Ball, Родитель AS Name, Адрес_Реб AS Specialization, Паспорт_Род  as Position, Паспорт_Реб as Position1, Адрес_Род as Position2 FROM data";
        ...
        private void Button_Click_9(object sender, RoutedEventArgs e)
        {
            ...
            string sqlQuery = $"SELECT id as Number,Ребенок as Ball, Родитель AS Name, Адрес_Реб AS Specialization, Паспорт_Род  as Position, Паспорт_Реб as Position1, Адрес_Род as Position2 FROM data where Ребенок='{textBoxFilter.Text}'";
        ...
        private void Button_Click_10(object sender, RoutedEventArgs e)
        {
            if (membersDataGrid.SelectedItem != null)
            {
                ...
                string sqlQuery = $"DELETE FROM data WHERE id='{numberValue}'";
            ...
            string sqlQuery1 = "SELECT id as Number,Ребенок as Ball, Родитель AS Name, Адрес_Реб AS Specialization, Паспорт_Род  as Position, Паспорт_Реб as Position1, Адрес_Род as Position2 FROM data";
